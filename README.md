...
Climbing Competition is an interactive website created with HTML, Cascading Style Sheet, and JavaScript for a rock-climbing fixture that has different pages (Home and About Page only). It is a responsive web page made for mobile, tablet, and desktop screens.
